...
type AuthService interface {
	...
	GetAdminDevice(ctx context.Context, input auth.GetAdminDeviceInput) (auth.AdminDevice, error)
	SetAdminDeviceStatus(ctx context.Context, input auth.SetAdminDeviceStatusInput) (auth.AdminDevice, error)
...
func New(options Options) *App {
	...
	mux.HandleFunc("/api/v1/admin/services/", app.handleAdminServiceByID)
	mux.HandleFunc("/api/v1/admin/devices", app.handleAdminDevices)
	mux.HandleFunc("/api/v1/admin/devices/", app.handleAdminDeviceByID)
